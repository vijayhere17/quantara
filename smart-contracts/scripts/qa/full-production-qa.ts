...
const TREASURY_ABI = [
  ...
  "function totalIncomeRecycled() view returns (uint256)",
  "function getAvailableDailyRoiBudget() view returns (uint256)",
  "function workingPayers(address) view returns (bool)",
  "function previewRecycling(uint256 amount) view returns (uint256 userPayout, uint256 toRoiPool, uint256 toReserve, uint256 toCommunity)",
  ...
  "event IncomeRecycled(address indexed user, uint256 grossAmount, uint256 userPayout, uint256 toRoiPool, uint256 toReserve, uint256 toCommunity)",
