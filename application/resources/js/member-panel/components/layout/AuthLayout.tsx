    ...
    <div className="member-panel-root relative min-h-screen overflow-x-hidden bg-transparent text-white">
      ...
      <div className="relative z-10 flex min-h-screen min-w-0">
        ...
        <div className="flex min-h-screen min-w-0 flex-1 flex-col">
          <main className="flex min-w-0 flex-1 items-center justify-center px-3 py-8 sm:px-6 sm:py-12">
            <div className="w-full min-w-0 max-w-full animate-fade-in">{children}</div>
          </main>
