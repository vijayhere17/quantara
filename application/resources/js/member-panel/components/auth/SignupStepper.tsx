...
export function SignupStepper({ steps, currentIndex }: SignupStepperProps) {
  ...
  return (
    <ol className="mb-4 w-full xl:mb-3.5" aria-label="Registration progress">
          ...
          return (
            <div key={s.id} className="flex min-w-0 flex-1 items-center">
              <div className="flex min-w-0 flex-col items-center gap-1">
                <motion.span
                  ...
                  className={[
                    ...
                    active
                      ? 'border-[#00B5FF]/70 bg-[#00B5FF]/20 text-[#38D9FF] shadow-[0_0_16px_rgba(0,181,255,0.45)]'
                      : done
              ...
              {index < steps.length - 1 ? (
                <div className="mx-1 mb-4 h-[2px] min-w-[8px] flex-1 overflow-hidden rounded-full bg-white/10">
                  <motion.div
