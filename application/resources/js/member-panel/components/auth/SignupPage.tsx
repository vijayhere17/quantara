    ...
    <>
      ...
      >
        <div className="mb-6 flex flex-col items-center text-center">
          ...
          <p className="mt-1.5 text-sm text-q-muted">On-chain registration on BNB Smart Chain</p>
        </div>
          ...
          <section className="space-y-5 animate-fade-in">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-q-muted">Enter your sponsor wallet / member ID.</p>
              </div>
            </div>
            <Input
          ...
          <section className="space-y-5 animate-fade-in">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-q-muted">Account details for login after registration.</p>
              </div>
            </div>
          ...
          <section className="space-y-5 animate-fade-in">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-q-muted">Only the starter package is unlocked for new registrations.</p>
              </div>
            </div>
          ...
          <section className="space-y-5 animate-fade-in">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-q-muted">Your wallet becomes the on-chain identity permanently.</p>
              </div>
            </div>
        ...
        {step === 'payment' ? (
          <section className="space-y-5 animate-fade-in">
            ...
            <label className="flex cursor-pointer items-start gap-3 rounded-xl border border-white/[0.08] bg-white/[0.03] px-4 py-3 text-sm text-q-soft">
              ...
              />
              <span>I agree to all the Terms &amp; Conditions of the Quantara ecosystem.</span>
            </label>
