			...
			<div class="panel-body">
				<div name="form1" class="form-horizontal form-groups-bordered validate" id="form1" role="form">
				    <div class="form-group">
						<label for="field-1" class="col-sm-3 control-label">Withdrawal Type</label>
						<div class="col-sm-5">
							<select id="withdraw_type" class="form-control" onchange="oTable.draw();">
							    <option value="1">Pending Request</option>
								<option value="2">Success Request</option>
							...
							<table id="tblData" border="0" width="100%" align="center" class="table table-bordered datatable">
								<thead>
									<tr class="seprator">
										...
										<th>Wallet</th>
										<th>Amount ($)</th>
										<th>Total Receive ROI</th>
										<th>Withdrawal Charge</th>
										<th>Net Capital Withdrawal</th>
										<th>&nbsp;</th>
									</tr>
								</thead>
								<tbody>
...
@section('jscontent')
	...
	<script src="{{ URL::asset('assets/admin/js/custom/member-staked-withdrawal.js') }}"></script>
@endsection
