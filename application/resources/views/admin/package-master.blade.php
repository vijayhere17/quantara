		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
				<div name="form1" class="form-horizontal form-groups-bordered validate" id="form1" role="form">
					...
					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label">Coin</label>
						<div class="col-sm-5">
							<input name="coin" type="num" class="form-control" id="coin" data-validate="required" placeholder="Coin">
						</div>
					</div>
					...
					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label">DMC Commission</label>
						<div class="col-sm-5">
							<input name="dmc_commission" type="num" class="form-control" id="dmc_commission" data-validate="required" placeholder="DMC Commission">
						</div>
					</div>
					
					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label">Left DMC</label>
						<div class="col-sm-5">
							<input name="left_dmc" type="num" class="form-control" id="left_dmc" data-validate="required" placeholder="Left DMC">
						</div>
					</div>
					
					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label">Right DMC</label>
						<div class="col-sm-5">
							<input name="right_dmc" type="num" class="form-control" id="right_dmc" data-validate="required" placeholder="Right DMC">
						</div>
					</div>
...
@endsection
@section('jscontent')
	<script src="{{ URL::asset('assets/admin/js/custom/package-master.js') }}"></script>
@endsection