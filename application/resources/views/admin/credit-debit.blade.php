		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
				<div name="form1" class="form-horizontal form-groups-bordered validate" id="form1" role="form">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<select id="wallet" class="form-control">
								<option value="Earning Wallet">Earning Wallet</option>
					...
					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label">Action</label>
						<div class="col-sm-5">
...
@endsection
@section('jscontent')
	<script src="{{ URL::asset('assets/admin/js/custom/cradit-debit.js') }}"></script>
@endsection