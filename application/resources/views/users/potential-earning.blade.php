            ...
            <div class="col-md-6 col-xl-4">
                <div class="card social-widget-card bg-info">
                    <div class="card-body p-3">
                        ...
                        <i class="fab fa-credit" style="margin-top: -7px;"><img src="{{ URL::to('/') }}/assets/images/logo-lg.png" alt="user-image" class="user-avtar wid-35" /></i>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-xl-4">
                <div class="card social-widget-card bg-danger">
                    <div class="card-body p-3">
                        ...
                        <i class="fab fa-debit" style="margin-top: -7px;"><img src="{{ URL::to('/') }}/assets/images/logo-lg.png" alt="user-image" class="user-avtar wid-35" /></i>
                    </div>
                </div>
            </div>
...
@endsection
@section('jscontent')
<script src="{{ URL::to('/') }}/assets/js/users/potential-earning.js"></script>
@endsection
