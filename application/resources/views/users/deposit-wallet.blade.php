            ...
            <div class="col-md-6 col-xl-4">
                <div class="card social-widget-card bg-info">
                    <div class="card-body p-3">
                        ...
                        <h3 class="text-white m-0 cradit">0.00000</h3>
            ...
            <div class="col-md-6 col-xl-4">
                <div class="card social-widget-card bg-danger">
                    <div class="card-body p-3">
                        ...
                        <h3 class="text-white m-0 debit">0.00000</h3>
                        <i class="fab fa-bitcoin" style="margin-top: -7px;"></i>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <h4 class="mb-0 text-white balance">0.00000</h4>
                            </div>
                            <div class="avtar">
...
@endsection
@section('jscontent')
<script src="{{ URL::to('/') }}/assets/js/users/deposit-wallet.js"></script>
@endsection
