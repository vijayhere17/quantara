...
{setTimeout(checklogin(),600);},2);},820);});},650);}});var is_lockscreen=$(".login-page").hasClass('is-lockscreen');if(is_lockscreen)
...
{setTimeout(function()
{neonLogin.setPercentage(100,function()
{setTimeout(checklogin(),600);},2);},820);});},650);}});}
...
{ 
	...
	var url="checklogin.php?sid=" + Math.random() + "&username=" + document.getElementById("username").value + "&password=" + document.getElementById("password").value
	xmlHttp=GetXmlHttpObject(setlogin)
...
function setlogin() 
{
	...
	{ 
		document.getElementById("login_text").innerHTML="logging in..."
	}
	...
	{ 
		...
		{
			document.getElementById("login_text").innerHTML="Login Success...."
		...
		{
			//alert(xmlHttp.responseText);
			document.getElementById("login_text").innerHTML="Invalid Username or Password."
