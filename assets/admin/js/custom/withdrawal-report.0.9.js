            ...
            
            {
                ...
                render: function(data, type, full, meta) {
                    if(PHP2JS.data.status == 0){
                        return '<a href="javascript:actionwithdrawalreq('+data+', 2, `approve`)" class="btn btn-info btn-sm btn-icon icon-left btn-info"><i class="entypo-pencil"></i>Approved</a>&nbsp;&nbsp;<a href="javascript:actionwithdrawalreq('+data+', 5, `paid`)" class="btn btn-success btn-sm">Paid</a>&nbsp;&nbsp;<a href="javascript:actionwithdrawalreq('+data+', 3, `reject`)" class="btn btn-danger btn-sm btn-icon icon-left btn-danger"><i class="entypo-cancel"></i>Rejected</a>';
                    }else if(PHP2JS.data.status == 1){
                        return '<a href="javascript:actionwithdrawalreq('+data+', 5, `paid`)" class="btn btn-success btn-sm">Paid</a>&nbsp;&nbsp;<a href="javascript:actionwithdrawalreq('+data+', 4, `pending`)" class="btn btn-info btn-sm btn-icon icon-left btn-info"><i class="entypo-pencil"></i>Make It Pending</a>';
                    }else if(PHP2JS.data.status == 3){
                        return '<a href="javascript:actionwithdrawalreq('+data+', 5, `paid`)" class="btn btn-success btn-sm">Paid</a>&nbsp;&nbsp;<a href="javascript:actionwithdrawalreq('+data+', 4, `pending`)" class="btn btn-info btn-sm btn-icon icon-left btn-info"><i class="entypo-pencil"></i>Make It Pending</a>';
                    }else{
                        return '';
                    }
